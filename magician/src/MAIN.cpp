...
int main(int argc, char* argv[])
{
	//CD learning
	if(argc < 9) {
		cout<<"Usage::./cdlearn mlnfile evidfile queryfile secconds ibound LEARN outputmlnfile"<<endl;
		//cout<<"Usage::./cdlearn mlnfile evidfile queryfile totaliters ibound TEST resultfilename"<<endl;
		cout<<"Usage::./cdlearn mlnfile evidfile queryfile seconds ibound MAR resultfilename constraints"<<endl;
	...
	if(option.compare("LEARN")==0) {
        ...
        mln.sample(mlnfile,evidfile,qryfile,itrs,bound,outmln);
	}
